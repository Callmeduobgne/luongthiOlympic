...
-   Docker 24.0+
-   Docker Compose 2.20+
-   16GB RAM minimum (khuyến nghị 32GB)
-   50GB disk space

### 📖 Hướng Dẫn Cài Đặt Chi Tiết

> **Xem hướng dẫn đầy đủ tại [SETUP.md](SETUP.md)** - Bao gồm cài đặt từ A-Z, từ máy mới chưa có gì đến chạy được chaincode.

### Khởi Động Nhanh (Đã có crypto materials)
...
### Cài Đặt Từ Đầu (Máy mới, chưa có crypto)
...
# Tạo crypto materials và channel artifacts
...
| Script | Mô tả |
|--------|-------|
| `scripts/generate-crypto.sh` | Tạo crypto materials và genesis block từ đầu |
| `scripts/join-orderers.sh` | Join orderers vào channel (cần chạy mỗi lần restart) |
| `scripts/deploy-chaincode-ccaas.sh` | Deploy chaincode tự động (CCaaS) |
| `scripts/test-chaincode.sh` | Test các functions của chaincode |
...
# Kiểm tra chaincode đã deployed
...
| Tài liệu | Mô tả |
|----------|-------|
| [**SETUP.md**](SETUP.md) | **Hướng dẫn cài đặt từ A-Z** - Từ máy mới đến chạy chaincode ⭐ |
| [Backend Architecture](docs/v1.0.1/backend.md) | Kiến trúc Backend Layer |
| [Network Architecture](docs/v1.0.1/network.md) | Kiến trúc Blockchain Network |
| [API Gateway](docs/v1.0.1/gateway.md) | API Gateway & Chaincode Lifecycle |
