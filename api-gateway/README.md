...
Access the API:
- **API Endpoint**: http://localhost:9805
- **Swagger UI**: http://localhost:9805/swagger/index.html
- **Health Check**: http://localhost:9805/health
- **Metrics**: http://localhost:9805/metrics
